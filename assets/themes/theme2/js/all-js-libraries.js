...
!(function (e, t) {
  ...
  var e = function (t, o) {
      ...
      return this && this instanceof e
          ? !!t && ((this.params = Object.assign(i, o)), (this.selector = t instanceof NodeList ? t : document.querySelectorAll(t)), (this.root = document.querySelector("body")), void this.run())
          : new e(t, o);
  };
  return (
      (e.prototype = {
          ...
          parseUrl: function (e) {
              ...
              return (
                  (t = e.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/))
                      ...
                      : (t = e.match(/https?:\/\/(?:www\.)?vimeo.com\/(?:channels\/|groups\/([^\/]*)\/videos\/|album\/(\d+)\/video\/|)(\d+)(?:$|\/|\?)/))
          ...
          events: function () {
              ...
              e.addEventListener(
                  "click",
                  function (t) {
                      ((t.target && "SPAN" === t.target.nodeName && "mediabox-close" === t.target.className) ||
                          ("DIV" === t.target.nodeName && "mediabox-wrap" === t.target.className) ||
                          ("mediabox-content" === t.target.className && "IFRAME" !== t.target.nodeName)) &&
                          this.close(e);
                  }.bind(this),
                  !1
              ),
  ...
  Object.defineProperty(Object, "assign", {
      value: function (e, t) {
          ...
          for (var o = Object(e), i = 1; i < arguments.length; i++) {
              var r = arguments[i];
              if (null != r) for (var n in r) Object.prototype.hasOwnProperty.call(r, n) && (o[n] = r[n]);
          }
          return o;
      },
      writable: !0,
...
("use strict");
const countdownFunction = (e) => document.querySelector(e),
  countdown = function (e) {
      const t = countdownFunction(e.target).getAttribute("data-date").split("-"),
          r = parseInt(t[0]),
          n = parseInt(t[1]),
          a = parseInt(t[2]);
      let o,
          d,
          i = countdownFunction(e.target).getAttribute("data-time");
      ...
      (countdownFunction(e.target + " .day .word").innerHTML = e.dayWord), (countdownFunction(e.target + " .hour .word").innerHTML = e.hourWord), (countdownFunction(e.target + " .min .word").innerHTML = e.minWord), (countdownFunction(e.target + " .sec .word").innerHTML = e.secWord);
      const s = () => {
          ...
          requestAnimationFrame(s),
              (countdownFunction(e.target + " .day .num").innerHTML = addZero(n)),
              (countdownFunction(e.target + " .hour .num").innerHTML = addZero(a)),
              (countdownFunction(e.target + " .min .num").innerHTML = addZero(o)),
              (countdownFunction(e.target + " .sec .num").innerHTML = addZero(d)),
              r < 0 && (countdownFunction(".countdown").innerHTML = "EXPIRED");
      };
      s();
  },
