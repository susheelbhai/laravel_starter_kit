...
class FormsController extends Controller
{
    public function simpleCreate(): Response
    {
        ...
        return Inertia::render('admin/resources/forms/simple-create');
    }
    public function editorCreate(): Response
    {
        return Inertia::render('admin/resources/forms/editor-create');
    }
    public function dateCreate(): Response
    {
        return Inertia::render('admin/resources/forms/date-create');
    }
    public function selectCreate(): Response
    {
        ...
        return Inertia::render('admin/resources/forms/select-create', compact('states'));
    }
    public function fileCreate(): Response
    {
        return Inertia::render('admin/resources/forms/file-create');
    }
    public function imageCreate(): Response
    {
        return Inertia::render('admin/resources/forms/image-create');
    }
    ...
    {
        $data = [];
        return Inertia::render('admin/resources/forms/wizard/create', compact('data'));
    }
