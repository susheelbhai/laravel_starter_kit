<!-- Start Counter Area -->
    <div class="section counter-area bg-color-3270ff pt-100 pb-70">
        <div class="container">
            <div class="row">
        ...
        <img src="{{ asset('storage/themes/tefri') }}/images/counter-shape-1.png" alt="Image" class="shape counter-shape-1">
        <img src="{{ asset('storage/themes/tefri') }}/images/counter-shape-2.png" alt="Image" class="shape counter-shape-2">
    </div>
    <!-- End Counter Area -->