        ...
        <div class="container">
            ...
            <div class="row g-0 border justify-content-center">
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="demo-single-feature border py-4 px-3 text-center wow fadeInUp" data-wow-delay="200ms">
                        <img class="mb-3" src="{{ asset('storage/themes/theme2') }}/img/demo-img/tpl/bootstrap.png"
                            alt="">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="demo-single-feature border py-4 px-3 text-center wow fadeInUp" data-wow-delay="200ms">
                        <img class="mb-3" src="{{ asset('storage/themes/theme2') }}/img/demo-img/tpl/js.png"
                            alt="">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="demo-single-feature border py-4 px-3 text-center wow fadeInUp" data-wow-delay="200ms">
                        <img class="mb-3" src="{{ asset('storage/themes/theme2') }}/img/demo-img/tpl/npm.png"
                            alt="">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="demo-single-feature border py-4 px-3 text-center wow fadeInUp" data-wow-delay="200ms">
                        <img class="mb-3" src="{{ asset('storage/themes/theme2') }}/img/demo-img/tpl/gulp.png"
                            alt="">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="demo-single-feature border py-4 px-3 text-center wow fadeInUp" data-wow-delay="200ms">
                        <img class="mb-3" src="{{ asset('storage/themes/theme2') }}/img/demo-img/tpl/pug.png"
                            alt="">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="demo-single-feature border py-4 px-3 text-center wow fadeInUp" data-wow-delay="200ms">
                        <img class="mb-3" src="{{ asset('storage/themes/theme2') }}/img/demo-img/tpl/sass.png"
                            alt="">
                ...
                <div class="col-6 col-lg-3">
                    <div class="demo-single-feature border py-4 px-3 text-center wow fadeInUp" data-wow-delay="200ms">
                        <img class="mb-3" src="{{ asset('storage/themes/theme2') }}/img/demo-img/tpl/css3.png"
                            alt="">
                ...
                <div class="col-6 col-lg-3">
                    <div class="demo-single-feature border py-4 px-3 text-center wow fadeInUp" data-wow-delay="200ms">
                        <img class="mb-3" src="{{ asset('storage/themes/theme2') }}/img/demo-img/tpl/html5.png"
                            alt="">
        ...
        <div class="container">
            <div class="row g-5 saasbox-portfolio-filter">
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/portfolio-creative.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/pc.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Portfolio Creative</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/portfolio-standard.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/ps.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Portfolio Standard</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/portfolio-full-width.html"
                            target="_blank"><img src="{{ asset('storage/themes/theme2') }}/img/demo-img/p-full.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/portfolio-details-one.html"
                            target="_blank"><img src="{{ asset('storage/themes/theme2') }}/img/demo-img/pd1.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/portfolio-details-two.html"
                            target="_blank"><img src="{{ asset('storage/themes/theme2') }}/img/demo-img/pd2.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/portfolio-details-three.html"
                            target="_blank"><img src="{{ asset('storage/themes/theme2') }}/img/demo-img/pd3.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/single-product.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/s-details.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/shop-fullwidth.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/s-full.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/shop-sidebar.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/s-sidebar.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/cart.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/cart.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Cart</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/checkout.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/checkout.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/about-creative.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/ac.png" alt=""></a>
                        <h5 class="mb-0 mt-4">About Creative</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/about-standard.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/as.png" alt=""></a>
                        <h5 class="mb-0 mt-4">About Standard</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/blog-1.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/b1.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Blog 1</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/blog-2.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/b2.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Blog 2</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/blog-3.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/b3.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Blog 3</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/blog-details-1.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/bd1.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Blog Details 1</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/blog-details-2.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/bd2.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Blog Details 2</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/blog-details-3.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/bd3.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Blog Details 3</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/coming-soon.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/cs.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Coming Soon</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/contact.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/contact.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/faq.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/faq.png" alt=""></a>
                        <h5 class="mb-0 mt-4">FAQ</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/forget-password.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/forget.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/login.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/login.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Login</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/newsletter.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/newsletter.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/pricing-plan.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/pt.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Pricing Plan</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/register.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/register.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/reviews.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/reviews.png"
                                alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/service-creative.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/sc.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Service Creative</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/service-standard.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/ss.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Service Standard</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/team.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/team.png" alt=""></a>
                        <h5 class="mb-0 mt-4">Team</h5>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 portfolio-item">
                    <div class="single-preview-area text-center wow fadeInUp" data-wow-delay="200ms"><a
                            href="{{ asset('storage/themes/theme2') }}/404.html" target="_blank"><img
                                src="{{ asset('storage/themes/theme2') }}/img/demo-img/404.png" alt=""></a>
