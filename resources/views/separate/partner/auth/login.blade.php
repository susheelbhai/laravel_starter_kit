<x-layout.partner.guest>
    ...
    <x-form.type.login title="Sign in your account" action="{{ route('partner.login') }}" submitName="Sign Me In">
        ...
        <div class="mb-3">
            <a href="{{ route('partner.password.request') }}">Forgot Password?</a>
        </div>
    </x-form.type.login>
