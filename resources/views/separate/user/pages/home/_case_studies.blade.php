    ...
    <div class="custom-container">
        ...
        <div class="case-studio">
            ...
            <ul class="nav nav-pills case-studio-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <button class="nav-link active" id="development-tab" data-bs-toggle="tab" href="{{ asset('themes/guest') }}/#development"
                        role="tab" aria-controls="development" aria-selected="true">Development</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" id="woo_commerce-tab" data-bs-toggle="tab" href="{{ asset('themes/guest') }}/#woo_commerce" role="tab"
                        aria-controls="woo_commerce" aria-selected="false">Woo Commerce</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" id="crm_solutions-tab" data-bs-toggle="tab" href="{{ asset('themes/guest') }}/#crm_solutions"
                        role="tab" aria-controls="crm_solutions" aria-selected="false">CRM Solutions</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" id="web_designing-tab" data-bs-toggle="tab" href="{{ asset('themes/guest') }}/#web_designing"
                        role="tab" aria-controls="web_designing" aria-selected="false">Web Designing</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" id="it_support-tab" data-bs-toggle="tab" href="{{ asset('themes/guest') }}/#it_support" role="tab"
                    ...
                    <div class="case-studio-body d-flex">
                        ...
                        <div class="right">
                            <div class="case-studio-contents service-card card-h">
                                ...
                                <a href="{{ asset('themes/guest') }}/#" class="theme-btn">
