            ...
            {errors?.length ? (
                ...
                <>
                    <div className="mx-auto flex max-w-md overflow-hidden">
                        <div className="mx-auto aspect-square w-64 rounded-div border border-border">
                    ...
                    <div className="flex w-full space-x-2">
                        <div className="flex w-full items-stretch overflow-hidden rounded-div border border-border">
                            {!manualSetupKey ? (
