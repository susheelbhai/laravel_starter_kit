...
export default function PreviewBasicDetails({ data, event_types, event_primary_foci }: any) {
    ...
    const primaryFocus = getTitles(data.event_primary_focus_ids, event_primary_foci);
