...
export default function Login({ submitUrl, status, canResetPassword }: LoginProps) {
    ...
    return (
        <AuthLayout title="Log in to your account" description="Enter your email and password below to log in">
            <Head title="Log in" />
            <ContinueWithGoogle href={route('seller.social.login', 'google')} />
            <ContinueWithFacebook href={route('seller.social.login', 'facebook')} />
            <ContinueWithX href={route('seller.social.login', 'x')} />
            <ContinueWithLinkedIn href={route('seller.social.login', 'linkedin')} />
            <ContinueWithText />
