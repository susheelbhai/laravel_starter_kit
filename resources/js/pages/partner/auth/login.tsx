...
export default function Login({ submitUrl, status, canResetPassword }: LoginProps) {
    ...
    return (
        <AuthLayout title="Log in to your account" description="Enter your email and password below to log in">
            <Head title="Log in" />
            <ContinueWithGoogle href={route('partner.social.login', 'google')} />
            <ContinueWithFacebook href={route('partner.social.login', 'facebook')} />
            <ContinueWithX href={route('partner.social.login', 'x')} />
            <ContinueWithLinkedIn href={route('partner.social.login', 'linkedin')} />
            <ContinueWithText />
                ...
                <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center">
                            ...
                            {canResetPassword && (
                                <TextLink href={route('partner.password.request')} className="ml-auto text-sm" tabIndex={5}>
                                    Forgot password?
                                </TextLink>
                            )}
                        </div>
