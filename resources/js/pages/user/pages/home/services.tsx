export default function ServicesSection(data: any) {
    return (
        <section id="services" className="bg-[#F5F6FA] py-20 md:py-28">
            <div className="mx-auto max-w-[1320px] px-4 text-center md:px-6">
                <span className="text-sm font-semibold text-[#FAB915] uppercase">What We Do</span>
                <h2 className="mt-2 mb-12 text-3xl font-bold md:text-5xl">Our Services</h2>
