...
<section id="newsletter" className="bg-white py-20 md:py-28">
                <div className="mx-auto max-w-[700px] px-4 text-center md:px-6">
                    <span className="text-sm font-semibold text-primary uppercase">Newsletter</span>
                    ...
                    <form className="mx-auto flex max-w-md">
                        <input
                            ...
                            className="flex-grow rounded-l-md border border-gray-300 px-4 py-3 focus:ring-2 focus:ring-primary focus:outline-none"
                        />
                        <button type="submit" className="rounded-r-md bg-primary px-6 py-3 font-semibold text-white hover:bg-primary/90 transition">
                            Subscribe
                        </button>
                    </form>
                </div>
