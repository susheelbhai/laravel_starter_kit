...
<div id="side-bar" class="side-bar">
    ...
    <div class="rts-sidebar-menu-desktop">
        <a class="logo-1" href="{{ route('home') }}"><img class="logo" src="{{asset(config('app.dark_logo', 'dummy.png'))}}" width="150px" alt="app_logo"></a>
        <a class="logo-2" href="{{ route('home') }}"><img class="logo" src="{{asset(config('app.dark_logo', 'dummy.png'))}}" width="150px" alt="app_logo"></a>
        <a class="logo-3" href="{{ route('home') }}"><img class="logo" src="{{asset(config('app.dark_logo', 'dummy.png'))}}" width="150px" alt="app_logo"></a>
        <a class="logo-4" href="{{ route('home') }}"><img class="logo" src="{{asset(config('app.dark_logo', 'dummy.png'))}}" width="150px" alt="app_logo"></a>
