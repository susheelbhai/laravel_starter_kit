...
<head>
    ...
    <link href="{{ asset('themes/theme1') }}/vendor_components/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
    <!-- Daterange picker -->
    <link href="{{ asset('themes/theme1') }}/vendor_components/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
    <!-- Clockpicker -->
    <link href="{{ asset('themes/theme1') }}/vendor_components/clockpicker/css/bootstrap-clockpicker.min.css" rel="stylesheet">
	
    <!-- Pick date -->
    <link rel="stylesheet" href="{{ asset('themes/theme1') }}/vendor_components/pickadate/themes/default.css">
    <link rel="stylesheet" href="{{ asset('themes/theme1') }}/vendor_components/pickadate/themes/default.date.css">
